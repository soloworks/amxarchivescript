# Powershell tool to produce release versions of AMX code
# Created by Solo Control
# Zip files created are saved in Parent directory (..\)
...
#$newsize.Width = 120            # Set the new Window Width to 150 columns.
$newsize.Height = 30            # Set the new Window Width to 150 columns.
$pswindow.windowsize = $newsize # Set the new Window Size as active.

# Start Utility
Write-Host 'Solo Control AMX Workspace Release Tool'
Write-Host ''
